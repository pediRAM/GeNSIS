...
namespace GeNSIS.UI
{
    ...
    public partial class SettingDialog : Window, INotifyPropertyChanged
    {
        ...
        public SettingDialog(ESettingType pSettingType) : base()
        {
        ...
        /*
        public XXXModel ToModel(IXXX pXXX)
        {
            return new XXXModel
            {
                Name = pXXX.Name,
                Title = pXXX.Title,
                Description = pXXX.Description,
                Label = pXXX.Label,
                SettingType = pXXX.SettingType,
                BoolValue = pXXX.BoolValue,
                StringValue = pXXX.StringValue,
                IntegerValue = pXXX.IntegerValue,
                PasswordValue = pXXX.PasswordValue,
            };
        }

        public void UpdateValues(IXXX pXXX)
        {
            Name = pXXX.Name;
            Title = pXXX.Title;
            Description = pXXX.Description;
